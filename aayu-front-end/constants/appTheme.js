...
export const appFonts = {
    ...
    bdy1: { fontFamily: "Roboto", fontSize: cntSizes.body1, lineHeight: 36 },
    bdy2: { fontFamily: "Roboto", fontSize: cntSizes.body2, lineHeight: 30 },
    bdy3: { fontFamily: "Roboto", fontSize: cntSizes.body3, lineHeight: 22 },
    bdy4: { fontFamily: "Roboto", fontSize: cntSizes.body4, lineHeight: 22 },
